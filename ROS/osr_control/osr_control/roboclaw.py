...
class Roboclaw:
    ...
    def _read1(self, cmd=0, address=0):
    ...
    def _read2(self, cmd=0, address=0):
        trys = self._trystimeout
        while 1:
            self._port.flushInput()
            self._sendcommand(address, cmd)
    ...
    def _read4(self, cmd=0, address=0):
        trys = self._trystimeout
        while 1:
            self._port.flushInput()
            self._sendcommand(address, cmd)
    ...
    def _read4_1(self, cmd=0, address=0):
        trys = self._trystimeout
        while 1:
            self._port.flushInput()
            self._sendcommand(address, cmd)
    ...
    def _read_n(self, cmd, args=0, address=0):
        trys = self._trystimeout
        while 1:
            self._port.flushInput()
            trys -= 1
    ...
    def _write0(self, cmd=0, address=0):
        trys = self._trystimeout
        while trys:
            self._sendcommand(address, cmd)
    ...
    def _write1(self, cmd, val=0, address=0):
        trys = self._trystimeout
        while trys:
            self._sendcommand(address, cmd)
            self._writebyte(val)
    ...
    def _write11(self, cmd, val1, val2=0, address=0):
        trys = self._trystimeout
        while trys:
            self._sendcommand(address, cmd)
    ...
    def _write111(self, cmd, val1, val2, val3=0, address=0):
        trys = self._trystimeout
        while trys:
            self._sendcommand(address, cmd)
            self._writebyte(val1)
    ...
    def _write2(self, cmd, val=0, address=0):
        trys = self._trystimeout
        while trys:
            self._sendcommand(address, cmd)
            self._writeword(val)
    ...
    def _writeS2(self, cmd, val=0, address=0):
        trys = self._trystimeout
        while trys:
            self._sendcommand(address, cmd)
    ...
    def _write22(self, cmd, val1, val2, address=0):
        trys = self._trystimeout
        while trys:
            self._sendcommand(address, cmd)
    ...
    def _writeS22(self, cmd, val1, val2, address=0):
        trys = self._trystimeout
        while trys:
            self._sendcommand(address, cmd)
    ...
    def _writeS2S2(self, cmd, val1, val2, address=0):
        trys = self._trystimeout
        while trys:
            self._sendcommand(address, cmd)
            self._writesword(val1)
    ...
    def _writeS24(self, cmd, val1, val2, address=0):
        trys = self._trystimeout
        while trys:
            self._sendcommand(address, cmd)
            self._writesword(val1)
    ...
    def _writeS24S24(self, cmd, val1, val2, val3, val4, address=0):
        trys = self._trystimeout
        while trys:
            self._sendcommand(address, cmd)
            self._writesword(val1)
    ...
    def _write4(self, cmd, val, address=0):
        trys = self._trystimeout
        while trys:
            self._sendcommand(address, cmd)
            self._writelong(val)
    ...
    def _writeS4(self, cmd, val, address=0):
        trys = self._trystimeout
        while trys:
            self._sendcommand(address, cmd)
    ...
    def _write44(self, cmd, val1, val2, address=0):
        trys = self._trystimeout
        while trys:
            self._sendcommand(address, cmd)
    ...
    def _write4S4(self, cmd, val1, val2, address=0):
        trys = self._trystimeout
        while trys:
            self._sendcommand(address, cmd)
            self._writelong(val1)
    ...
    def _writeS4S4(self, cmd, val1, val2, address=0):
        trys = self._trystimeout
        while trys:
            self._sendcommand(address, cmd)
    ...
    def _write441(self, cmd, val1, val2, val3, address=0):
        trys = self._trystimeout
        while trys:
            self._sendcommand(address, cmd)
            self._writelong(val1)
    ...
    def _writeS441(self, cmd, val1, val2, val3, address=0):
        trys = self._trystimeout
        while trys:
            self._sendcommand(address, cmd)
            self._writeslong(val1)
    ...
    def _write4S4S4(self, cmd, val1, val2, val3, address=0):
        trys = self._trystimeout
        while trys:
            self._sendcommand(address, cmd)
            self._writelong(val1)
    ...
    def _write4S441(self, cmd, val1, val2, val3, val4, address=0):
        trys = self._trystimeout
        while trys:
            self._sendcommand(address, cmd)
            self._writelong(val1)
    ...
    def _write4444(self, cmd, val1, val2, val3, val4, address=0):
        trys = self._trystimeout
        while trys:
            self._sendcommand(address, cmd)
            self._writelong(val1)
    ...
    def _write4S44S4(self, cmd, val1, val2, val3, val4, address=0):
        trys = self._trystimeout
        while trys:
            self._sendcommand(address, cmd)
            self._writelong(val1)
    ...
    def _write44441(self, cmd, val1, val2, val3, val4, val5, address=0):
        trys = self._trystimeout
        while trys:
            self._sendcommand(address, cmd)
            self._writelong(val1)
    ...
    def _writeS44S441(self, cmd, val1, val2, val3, val4, val5, address=0):
        trys = self._trystimeout
        while trys:
            self._sendcommand(address, cmd)
            self._writeslong(val1)
    ...
    def _write4S44S441(self, cmd, val1, val2, val3, val4, val5, val6, address=0):
        trys = self._trystimeout
        while trys:
            self._sendcommand(address, cmd)
            self._writelong(val1)
    ...
    def _write4S444S441(self, cmd, val1, val2, val3, val4, val5, val6, val7, address=0):
        trys = self._trystimeout
        while trys:
    ...
    def _write4444444(self, cmd, val1, val2, val3, val4, val5, val6, val7, address=0):
        trys = self._trystimeout
        while trys:
            self._sendcommand(address, cmd)
            self._writelong(val1)
    ...
    def SetEncM2(self, cnt, address=0):
        return self._write4(address, self.Cmd.SETM2ENCCOUNT, cnt)

    def ReadMainBatteryVoltage(self, address=0):
    ...
    def SetMinVoltageLogicBattery(self, val, address=0):
        return self._write1(address, self.Cmd.SETMINLB, val)

    def SetMaxVoltageLogicBattery(self, val, address=0):
        return self._write1(address, self.Cmd.SETMAXLB, val)

    def SetM1VelocityPID(self, p, i, d, qpps, address=0):
    ...
    def SetM2VelocityPID(self, p, i, d, qpps, address=0):
    ...
    def SpeedAccelDistanceM1(self, accel, speed, distance, buffer, address=0):
        return self._write4S441(
            address, self.Cmd.M1SPEEDACCELDIST, accel, speed, distance, buffer
        )

    def SpeedAccelDistanceM2(self, accel, speed, distance, buffer, address=0):
        return self._write4S441(
    ...
    def ReadCurrents(self, address=0):
    ...
    def SpeedAccelM1M2_2(self, accel1, speed1, accel2, speed2, address=0):
    ...
    def ReadM2VelocityPID(self, address=0):
    ...
    def SetMainVoltages(self, min, max, address=0):
        return self._write22(address, self.Cmd.SETMAINVOLTAGES, min, max)

    def SetLogicVoltages(self, min, max, address=0):
        return self._write22(address, self.Cmd.SETLOGICVOLTAGES, min, max)

    def ReadMinMaxMainVoltages(self, address=0):
    ...
    def ReadMinMaxLogicVoltages(self, address=0):
    ...
    def SetM1PositionPID(self, kp, ki, kd, kimax, deadzone, min, max, address=0):
    ...
    def SetM2PositionPID(self, kp, ki, kd, kimax, deadzone, min, max, address=0):
    ...
    def ReadM1PositionPID(self, address=0):
    ...
    def ReadM2PositionPID(self, address=0):
    ...
    def SetDeadBand(self, min, max, address=0):
        return self._write11(address, self.Cmd.SETDEADBAND, min, max)

    def GetDeadBand(self, address=0):
    ...
    def WriteEeprom(self, ee_address, ee_word, address=0):
